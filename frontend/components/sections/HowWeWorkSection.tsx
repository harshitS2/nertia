...
const STEPS = [
  {
    ...
    accent: "from-[#25C4CB]/20 to-transparent",
  },
  {
    number: "02",
    icon:   Wrench,
    ...
    accent: "from-[#1A8C96]/15 to-transparent",
  },
  {
    number: "03",
    icon:   Rocket,
    ...
    accent: "from-[#2B5156]/25 to-transparent",
  },
  {
    number: "04",
    icon:   TrendingUp,
    ...
    accent: "from-[#25C4CB]/10 to-transparent",
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {STEPS.map(({ number, icon: Icon, title, body, accent }, index) => (
            <motion.div
              ...
              className={[
                "group relative p-8 rounded-2xl border border-white/8",
                `bg-gradient-to-br ${accent}`,
                "hover:border-[#25C4CB]/30 transition-all duration-300",
            ...
            >
              ...
              <div
                className="absolute -right-4 -bottom-4 text-[120px] font-black leading-none text-white/[0.02] select-none pointer-events-none transition-all duration-500 group-hover:text-[#25C4CB]/[0.05]"
                aria-hidden="true"
              >
                {number}
              </div>
              ...
              <div className="relative z-10 flex items-start gap-5 mb-5">
                ...
                <div className="flex-shrink-0 flex flex-col items-center gap-1.5">
                  <span className="text-[10px] font-bold tracking-[0.15em] text-[#25C4CB] uppercase">
                    Step
                  </span>
                ...
                {/* Icon + Title */}
                <div>
                  <div className="w-10 h-10 rounded-xl bg-[#25C4CB]/10 flex items-center justify-center mb-3 group-hover:bg-[#25C4CB]/20 transition-colors duration-300">
                    <Icon size={18} className="text-[#25C4CB]" />
                  </div>
              ...
              {/* Body text */}
              <p className="relative z-10 text-white/50 text-sm leading-relaxed pl-[72px]">
                {body}
              </p>
              ...
              <div
                ...
                style={{ background: "linear-gradient(to right, #25C4CB, transparent)" }}
                aria-hidden="true"
              />
            </motion.div>
          ))}
        ...
        >
          <div className="inline-block px-8 py-5 rounded-2xl border border-white/8 bg-white/[0.02]">
